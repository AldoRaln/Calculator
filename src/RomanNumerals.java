public class RomanNumerals {
    ...
    public static void main(String[] argv) {
        ...
        int cmParse = convertStringToInt("CM");
        if(cmParse == 900) {
        ...
        int cdParse = convertStringToInt("CD");
        if(cdParse == 400) {
        ...
        int xcParse = convertStringToInt("XC");
        if(xcParse == 90) {
        ...
        int xlParse = convertStringToInt("XL");
        if(xlParse == 40) {
        ...
        int ixParse = convertStringToInt("IX");
        if(ixParse == 9) {
        ...
        int ivParse = convertStringToInt("IV");
        if(ivParse == 4) {
        ...
        int notRoman = convertStringToInt("banana");
        ...
        int improperRoman = convertStringToInt("IIII");
        ...
        String cmFormat = convertIntToRoman(900);
        ...
        String cdFormat = convertIntToRoman(400);
        ...
        String xcFormat = convertIntToRoman(90);
        ...
        String xlFormat = convertIntToRoman(40);
        ...
        String ixFormat = convertIntToRoman(9);
        ...
        String ivFormat = convertIntToRoman(4);
